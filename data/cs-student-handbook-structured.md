...
[SKIPPING TABLE SECTION: 23.1] [SKIPPING TABLE SECTION: 24.1]
...
[](https://www.ucl.ac.uk/students/student-status/student-module-selection) [Student module selection](https://www.ucl.ac.uk/students/student-status/student-module-selection) [Overview of the module selection process.](https://www.ucl.ac.uk/students/student-status/student-module-selection) [](https://www.ucl.ac.uk/module-catalogue) [UCL Module Catalogue](https://www.ucl.ac.uk/module-catalogue) [Module descriptions - content & assessment.](https://www.ucl.ac.uk/module-catalogue) [](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-08-Programme-structure.aspx#undergraduate-programmes) [Undergraduate programme diets](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-08-Programme-structure.aspx#undergraduate-programmes) [BSc/ MEng programme diets.](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-08-Programme-structure.aspx#undergraduate-programmes) [](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-08-Programme-structure.aspx#postgraduate-taught-programmes-1) [Postgraduate taught programme diets](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-08-Programme-structure.aspx#postgraduate-taught-programmes-1) [MSc/ MRes programme diets.](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-08-Programme-structure.aspx#postgraduate-taught-programmes-1) Additional Resources [Office Hours & Drop-in Sessions](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/SitePages/SW--Support-Sessions.aspx) [Changelog](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-26-Changelog.aspx) [Annexes](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-00-Annexes.aspx) [Module catalogue corrections](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-01-Catalogue-corrections.aspx) [Applying for an Additional Year in Industry](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-02-Additional-Year-in-Industry.aspx) [Explanation of Weighted Means and Marks](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-03-Weighted-Means-and-Marks.aspx) [Handbook archive](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-04-Handbook-archive.aspx)
...
[SKIPPING TABLE SECTION: 2.3.] [SKIPPING TABLE SECTION: 2.4.]
...
Programmes are composed of modules, which are individual units of study which lead to the award of credit. The Programme Diet [specifies which modules are included in the programme.  Information about modules, their syllabuses, learning outcomes, and assessment](https://www.ucl.ac.uk/module-catalogue) methods is available via the [UCL Module Catalogue](https://www.ucl.ac.uk/module-catalogue). Further information:
...
weighted 1, year two weighted 3 and year three weighted 5. These thresholds apply to students first registered in 2024/25 and thereafter only. Further information:
...
Students are strongly encouraged to register with a doctor as soon as possible after they arrive in London so that they can access healthcare quickly if they become ill or injured. When attending a university in the UK students under the age of 25 are also advised to be vaccinated against meningitis (ACWY). The [Ridgmount Practice is a National Health Service (NHS) practice providing healthcare for students living within its catchment area (i.e.](http://www.gowerplacepractice.nhs.uk/) [near the main UCL campus). Students can also choose to register with a practice closer to where they live if they prefer. The Ridgmount](http://www.gowerplacepractice.nhs.uk/) Practice also runs a walk-in surgery which any UCL student can attend, even if they are not registered with the practice. Further information: [Registering with a doctor (GP) | UCL Students](https://www.ucl.ac.uk/students/support-and-wellbeing/health-care/registering-doctor-gp) [Ridgmont Practice | NHS UK](https://www.ucl.ac.uk/students/support-and-wellbeing/health-care/registering-doctor-gp)

### 15.2.2 Counselling, support and information helpline

As part of a partnership with an organisation external to UCL, we provide an information and counselling helpline. The helpline is free of charge and includes access to information specialists who are trained by Citizens Advice and to professionally qualified and BACP- accredited counsellors who can help students with a range of emotional and psychological difficulties. Further information: [24/7 Student Support Line | UCL Students](https://www.ucl.ac.uk/students/support-and-wellbeing/mental-health-and-wellbeing/ucl-247-student-support-line)
...
Taught postgraduate programmes Office Hours for taught postgraduate programmes are as follows: Times (24hr clock, Mode (online/on- Location Staff Staff UPI Role Day of the (on- campus) Meeting Link (online) week UK time) campus) Yassipour Tehrani, SYASS36 MSc Artificial Intelligence Thursday 12:00
- Hybrid [1.08, GS](https://www.ucl.ac.uk/maps/66-72-gower-street) By appointment via email Times (24hr clock, Mode (online/on- Location Staff Staff UPI Role Day of the (on- campus) Meeting Link (online) week UK time) campus) Sobhan and Data Engineering 13:00 MSc Artificial Intelligence for Biomedicine and Healthcare 14:00
- 15:00 Manescu, Petru PMANE23 Tuesday MSc Artificial Intelligence for Sustainable Development Bulathwela, Sahan MSSBU78 MSc Computational Finance Germano, Guido GGERM33 MSc Computational Statistics & Machine Learning 10:00
- 11:00 Adamskiy, Dmitry DADAM27 Monday Online

MSc Computer Graphics, Imaging & Vision Ritschel, Tobias TRITS30 Kouadri Mostefaoui, GKOUA81 MSc Computer Tuesday 15:00
- On-Campus Online Gower street [https://outlook.office365.com/owa/calendar/Officehou](https://outlook.office365.com/owa/calendar/Officehour4%40live.ucl.ac.uk/bookings/) Times (24hr clock, Mode (online/on- Location Staff Staff UPI Role Day of the (on- campus) Meeting Link (online) week UK time) campus) Ghita Science 16:00 66-72, Room 1.02. MSc Data Science and Machine Learning 10:00
- 11:00 Edwards, Eddie PEDWA66 Online

Monday MSc Design, Disability & Innovation 17:00
- 18:00 Cho, Youngjun YCHOX41 Tuesday 66-72 Gower Street, 5th Floor Hub MSc Emerging Digital Technologies 14:00
- 15:00 On-Campus Online Xu, Java JXUDX19 Tuesday 66-72 Gower Street, room 4.06 MSc Financial Risk Management 13:00
- 14:00 Caccioli, Fabio FCACC19 Wednesday On-campus Times (24hr clock, Mode (online/on- Location Staff Staff UPI Role Day of the (on- campus) Meeting Link (online) week UK time) campus) 66-72 Gower Street, 5th Floor Hub 17:00
- 18:00 Vadgama, Nikhil NVAGD45 MSc Financial Technology Friday On-Campus Online MSc Information Security 16:00
- 17:00 Jovanovic, Philipp PJOVA02 Wednesday Online
...
MSc Robotics and Artificial Intelligence Julier, Simon SJULI23 MSc Software Systems Engineering 15:00
- 16:00 Clark, David DCLAR93 Thursday Delibasi, Akin ADELI59 MSc Systems Engineering for the Monday 12:00
- 13:00 Hybrid [OPS](https://maps.app.goo.gl/RhsFbztSWsEnkpMVA) By appointment via email Times (24hr clock, Mode (online/on- Location Staff Staff UPI Role Day of the (on- campus) Meeting Link (online) week UK time) campus) Internet of Things London, London, United Kingdom 3:38 pm Tuesday, 29/07/2025 Quick links [Student Voice | CS Student Intranet](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/SitePages/SV--Student-Voice.aspx) [](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/SitePages/SV--Student-Voice.aspx) [Student Representation within the department](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/SitePages/SV--Student-Voice.aspx) Changelog

# 1. Changelog

Changes will be reported in the following format Date [Amended Page](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Home.aspx) List of updates

# 1. Changelog

2025-06-02 Updated Year 2 academic co-ordinator: From: [Paolo Tasca](https://search2.ucl.ac.uk/s/search.html?query=Paolo+Tasca&collection=website-meta&profile=_directory&tab=directory&sumbit=Go) [To: Madeline Carr](https://search2.ucl.ac.uk/s/search.html?query=Madeline+Carr&collection=website-meta&profile=_directory&tab=directory&sumbit=Go) 2025-01-30 Updated Item Description Dates/ deadline MEng to BSc Programme Transfers

Applications to transfer from the MEng Computer Science to BSc Computer Science to be made via Portico (only once permission has been given by the Programme Director) before the start of Term 1 of the Masters year. Students on Tier 4 Visas must seek the advice on UCL Visa Compliance prior making [the Transfer request.](https://www.ucl.ac.uk/academic-manual/chapters/chapter-3-registration-framework-taught-programmes/section-5-programme-transfers#5.2) [See: Academic Manual Chapter 3, Section 5.2](https://www.ucl.ac.uk/academic-manual/chapters/chapter-3-registration-framework-taught-programmes/section-5-programme-transfers#5.2) [Programme Transfers](https://www.ucl.ac.uk/academic-manual/chapters/chapter-3-registration-framework-taught-programmes/section-5-programme-transfers#5.2) [Week 4](https://www.ucl.ac.uk/srs/sites/srs/files/ucl_calendar_2024_25_1.pdf) [To be confirmed](https://www.ucl.ac.uk/srs/sites/srs/files/ucl_calendar_2024_25_1.pdf) BSc to MEng Programme Transfers Applications to transfer from the BSc Computer Science to MEng Computer Science to be made via Portico (only once permission has been given by the Programme Director.) Students on Tier 4 Visas must seek the advice on UCL Visa Compliance prior making the Transfer [request.](https://www.ucl.ac.uk/academic-manual/chapters/chapter-3-registration-framework-taught-programmes/section-5-programme-transfers#5.2) [See: Academic Manual Chapter 3, Section 5.2](https://www.ucl.ac.uk/academic-manual/chapters/chapter-3-registration-framework-taught-programmes/section-5-programme-transfers#5.2) [Programme Transfers](https://www.ucl.ac.uk/academic-manual/chapters/chapter-3-registration-framework-taught-programmes/section-5-programme-transfers#5.2) [Week 40](https://www.ucl.ac.uk/srs/sites/srs/files/ucl_calendar_2024_25_1.pdf) [To be confirmed](https://www.ucl.ac.uk/srs/sites/srs/files/ucl_calendar_2024_25_1.pdf) 2024-11-28 [Applying for an Additional Year in Industry](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-02-Additional-Year-in-Industry.aspx) Updated dates to reflect 2025-26, from TBC: Restrictions on Places Application Process Updated Stage 1, Step 4, to reflect the CS Tutor for year in Industry, not Programme Director, will review applications. 2024-11-04 Removed
...
determined.) The department reserves the right to rescind an application at any stage where a student's academic performance falls below the level expected. In that case, the student will continue on or transfer back to their originating programme of study (i.e. without Year in Industry.) Academic Requirements to submit a Placement Proposal  & Placement Application: Initial Academic Requirements: Between Years 2 and 3 In order to be eligible to apply for a Year in Industry Placement between Years 2 and 3 of a BSc or MEng, a student must: Pass 120 credits in Year 1; AND Achieve a [Classification Year Mean of at least 65.00% for Year 1.](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-03-Weighted-Means-and-Marks.aspx) If a student does not meet these requirements, then they are not eligible for a Placement and should not submit a Placement Proposal or Application. Between Years 3 and 4 In order to be eligible to apply for a Year in Industry Placement between Years 3 and 4 of an MEng, a student must: [Pass 240 credits over Years 1 and 2; AND](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-03-Weighted-Means-and-Marks.aspx) Achieve a [Final Weighted Mark](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-03-Weighted-Means-and-Marks.aspx) of at least 65.00% over Years 1 and 2. If a student does not meet these requirements, then they are not eligible for a Placement and should not submit a Placement Proposal or Application. Academic Requirements to commence a Placement: Final Academic Requirements: Between Years 2 and 3 In order to be eligible to commence a Year in Industry Placement between Years 2 and 3 of a BSc or MEng, a student should: Meet the Progression Criteria to Progress from Year 2 to Year 3 of their registered degree programme, [as per Chapter 4, Section 6.5 of the UCL Academic Manual](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-6-progression-award#6.5) and as per ‘Progression and Award rules’ in [Portico. [These can be found via: Portico > ‘My Studies’ > ‘My Programme’ > ‘Progression and Award](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-6-progression-award#6.5) rules’] If a student does not meet these requirements, then they are not eligible to commence a Placement. Between Years 3 and 4 In order to be eligible to commence a Year in Industry Placement between Years 3 and 4 of an MEng, a student should: Meet the Progression Criteria to Progress from Year 3 to Year 4 of their registered degree programme, [as per Chapter 4, Section 6.5 of the UCL Academic Manual](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-6-progression-award#6.5) and as per ‘Progression and Award rules’ in [Portico. [These can be found via: Portico > ‘My Studies’ > ‘My Programme’ > ‘Progression and Award](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-6-progression-award#6.5) rules’] If a student does not meet these requirements, then they are not eligible to commence a Placement. Application Process Stage 1: Initial Enquiry and Proposal Step Responsible Action Deadline/ time-frame 1 Student Check eligibility for a Placement Students must check their eligibility before they seek a suitable placement opportunity. A student who wishes to apply for a Year in Industry Placement must first ensure that they have met the Initial Academic Requirements (above) in order to be eligible to apply. A student who has not met the academic requirements is not permitted to apply. Year 2 students may apply to take an Additional Placement year in 2025/26, and defer their Year 3 studies to 2026/27. Year 3 (MEng only) students may apply to take an Additional Placement year in 2025/26, and defer their Year 4 studies to 2026/27. 2 Student Identify a Placement opportunity and notify the department Thursday 27 February – Thursday 13th March 2025 Step Responsible Action Deadline/ time-frame A student having met the Initial Academic Requirements should identify a suitable placement opportunity with a host company and establish an agreed point of contact. The student should notify the department of the desired industrial [placement and provide the details of an appropriate named contact for the host](mailto:cs.undergraduate@ucl.ac.uk) company (via [cs.undergraduate-students@ucl.ac.uk](mailto:cs.undergraduate@ucl.ac.uk).) (Applications will only progress where notification is received by Thursday 13th March 2025). At this point, the department will determine whether the student has met the Initial Academic Requirements: if these have not been achieved then the Proposal will not be progressed. 3 Student Complete and submit a Placement Proposal Submit Proposal Forms: The department will provide the student with a Year in Industry Proposal Form ("Proposal Form"). Monday 17 March – Friday 28 March 2025 [The student should complete the Proposal Form](mailto:cs.undergraduate@ucl.ac.uk) and submit this to the department (via [cs.undergraduate-students@ucl.ac.uk) by the deadline. If a ](mailto:cs.undergraduate@ucl.ac.uk)Proposal Form is [received before the permitted date or after the deadline then it will not be](mailto:cs.undergraduate@ucl.ac.uk) considered and the Proposal may not proceed. 4 Department Decision on the Placement Proposal Proposals will be reviewed from: The CS Tutor for Year in Industry will assess the proposed Placement in line with the learning outcomes of the student's degree programme and determine whether this may proceed based on its merit, timeliness, and whether places are available (i.e. considering the cap.) Friday 28th March 2025 Acceptance or Rejection decisions will be returned to the student by: Monday 14th April 2025 Stage 2: Application Following successful completion of Stage 1, where a Proposal is approved and the Initial Academic Requirements are met, the student may submit a Placement Application, as follows: Step Responsible Action Deadline/ time-frame 1 Student Complete and submit a Placement Application Deadline to submit Application forms: The department will provide the student with a Year in Industry Placement Application Pack ("Application Pack"), which comprises: Monday 12th May 2025 a Host Placement Agreement Form; a Student Letter Agreement Form; a Health and Safety Placement Checklist; and a Risk Assessment Form. The student must complete the Host Placement Agreement Form, Student Letter [Agreement Form, Health and Safety Placement Checklist, and Risk Assessment Form](mailto:cs.undergraduate@ucl.ac.uk) and submit these to the department (via [cs.undergraduate-students@ucl.ac.uk](mailto:cs.undergraduate@ucl.ac.uk)) by the deadline. If the complete set of these documents is not received by the deadline then the Placement may not proceed. 2 Department Risk Assessment of the proposed Placement Outcomes of the Risk Assessment by the Year in Industry Tutor will be returned to students by: The Year in Industry Tutor will carry out a risk assessment of the proposed Placement (also known as a 'Risk Profile'.) The risk level must be 'low' in order for the proposed Placement to be approved. Wednesday 21 May 2025 If the risk level is evaluated as 'high' then the Year in Industry Tutor will contact the student and the host company for the proposed Placement to discuss this and seek a resolution. If the risk level cannot be reduced to 'low' then the Placement may not proceed. 3 Department Head of Department decision on the proposed Placement Acceptance or Rejection decisions will be returned to the student by: The Head of Department will review the Application and Risk Profile and make a decision on whether the proposed Placement may proceed. Friday 30 May 2025 If the Head of Department goes not give their approval then the Placement may not proceed. Step Responsible Action Deadline/ time-frame 4 Student Submit application to change programme to the 'with Year in Industry' version. Deadline to transfer: The department will notify the student submit an application to transfer to the 'with Year in Industry' programme via Portico's 'Change to Registration - C2RS' function. This is a preparatory step and is not confirmation that the student may commence the Placement, which will be contingent on satisfying the Academic Requirements. Friday 13 June 2025 5 Department Review of eligibility and notification of final outcome July 2025, following Board of Examiners in June 2025 The department will determine whether the student has met the Final Academic Requirements: if these have not been achieved then the Placement may not be commenced and the student will be required to transfer back to their originating programme of study. The Teaching and Learning Team will notify the student of the final outcome. Stage 3: Placement Following commencement of the Placement: Step Responsible Action Deadline/ time-frame 1 Student Complete and submit a Placement Induction Checklist & point of contact Deadline to submit form: within 2 weeks of commencement of the placement The department will provide the student with a Placement Induction Checklist. The student must complete the Placement Induction Checklist and the name of a [point of contact with the host company (for engagement monitoring) and submit](mailto:cs.undergraduate@ucl.ac.uk) [these to the department (via cs.undergraduate-students@ucl.ac.uk) by the deadline.](mailto:cs.undergraduate@ucl.ac.uk) Step Responsible Action Deadline/ time-frame 2 Student Complete re-enrolment and module selection By the UCL Module Registration and Re-enrolment deadline The student completes re-enrolment and module selection with UCL; they will select the Placement Module (COMP0033: Computer Science Internship) as their only module. Annexes [Office Hours & Drop-in Sessions](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/SitePages/SW--Support-Sessions.aspx) [Changelog](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-26-Changelog.aspx) [Annexes](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-00-Annexes.aspx) [Module catalogue corrections](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-01-Catalogue-corrections.aspx) [Applying for an Additional Year in Industry](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-02-Additional-Year-in-Industry.aspx) [Explanation of Weighted Means and Marks](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-03-Weighted-Means-and-Marks.aspx) [Handbook archive](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-04-Handbook-archive.aspx) Explanation of Weighted Means and Marks Introduction Rounding Credit Weighted Mean Progression Year Mean Classification Year Mean Final Weighted Mark Disclaimer Introduction The [Academic Manual](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes) defines how students’ module marks are combined to determine their academic performance, Interim Programme [Status, Progression, Award, and Classification. The Academic Manual is definitive in this regard. The information presented on the page is](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes) as an aide to understanding some of the terminologies. Rounding Computer Science’s taught programmes operate numerical marking scales. Credit Weighted Means, Progression Year Means, Classification Year Means, and Final Weighted Marks are calculated to 2 decimal places. Credit Weighted Mean A Credit Weighted Mean (CWM) is calculated for one or more modules. It is the sum product of each Module Mark and its Credit Value as a proportion of the Total Credit value. Worked example Example marks Year of study Module code Credit value Module mark Included in example CWM 1 COMP0890 15 50 Y COMP0891 15 60 Y COMP0892 30 70 Y COMP0893 45 80

COMP0895 15 90

Example calculation This example calculates a CWM over a subset of Modules Marks within the same Year of Study (with a Total Credit value of 60 credits): Usage A Credit Weighted Mean may be used to determine a student’s interim progress, for example to assess their eligibility for programme transfer or for applying for an internship. CWMs for different purposes may factor different subsets of Module Marks. Progression Year Mean A [Progression Year Mean](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-9-progression-award#9.3.3) (PYM) is calculated for a Year of Study. It is the Credit Weighted Mean of all Module Marks in that Year of Study. Worked example Example marks Year of study Module code Credit value Module mark Included in example Year 1 COMP0890 15 50 Y COMP0891 15 60 Y COMP0892 30 70 Y COMP0893 45 80 Y COMP0895 15 90 Y Example calculation This example calculates a PYM over all Modules Marks within the same Year of Study (with a Total Credit Value of 120 credits in this case): Usage A Progression Year Mean is primarily used to determine a student’s Progression on an undergraduate programme with multiple Years of Study. Classification Year Mean A [Classification Year Mean (CYM) is calculated for a Year of Study. It is the Credit Weighted Mean of all Module Marks in that Year of Study](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-10-classification#10.2.2) [that count towards Award Classification (as determined by that programme’s Classification Scheme and any applicable No Detriment](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/section-10-classification#10.2.2) Regulations.) Worked example Example marks Year of study Module code Credit value Module mark Included in example Year 2 COMP0896 15 50

COMP0897 15 60

COMP0898 15 70

COMP0899 30 80 Y COMP0900 15 90 Y COMP0901 15 95 Y Example calculation This example calculates a CYM over all counting Modules Marks within the same Year of Study (where the counting Module Marks are the best 60 credits in this case): Usage A Classification Year Mean is primarily used, as component of the Final Weighted Mark, to determine a student’s Award Classification. A Classification Year Mean may be calculated over Module Marks from multiple Years of Study for the purpose of determining a student’s eligibility for applying for or commencing a Year in Industry (the CYM is not Year Weighted when calculated in this way.) Final Weighted Mark A Final Weighted Mark (FWM) is calculated for multiple Years of Study. It is a Year-Weighted Mean of the Classification Year Means (where the Year Weightings are determined by that programme’s Classification Scheme.) Worked example Example marks Year of study Module code Credit value Module mark Included in example Year 1 COMP0701 15 90 Y COMP0702 15 80 Y COMP0703 15 75 Y Year weighting: 1 COMP0704 15 60 Y COMP0705 30 70 Y COMP0706 30 70 Y Year 2 COMP0601 15 70 Y COMP0602 15 60 Y COMP0603 15 50 Y Year weighting: 3 COMP0604 15 75 Y COMP0605 30 80 Y COMP0606 30 85 Y Example calculation This example calculates a FWM over the Years of Study 1 and 2 (and where each Classification Year Mean includes all Module Marks in that Year of Study): Usage A Final Weighted Mark is primarily used to determine a student’s Award Classification. A Final Weighted Mark may be calculated over a subset of a programme’s Years of Study for the purpose of determining a student’s eligibility for applying for or commencing a Year in Industry or progressing on an MEng programme. Disclaimer Annexes [Office Hours & Drop-in Sessions](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/SitePages/SW--Support-Sessions.aspx) [Changelog](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-26-Changelog.aspx) [Annexes](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-00-Annexes.aspx) [Module catalogue corrections](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-01-Catalogue-corrections.aspx) [Applying for an Additional Year in Industry](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-02-Additional-Year-in-Industry.aspx) [Explanation of Weighted Means and Marks](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-03-Weighted-Means-and-Marks.aspx) [Handbook archive](https://liveuclac.sharepoint.com/sites/CSCStudentIntranet/CS-StudentHandbook/SitePages/Section-27-04-Handbook-archive.aspx) Handbook archive Introduction Archive documents Introduction The Computer Science Student Handbook is published as an online website/wiki. The process of converting this to a PDF document does not preserve the original formatting, therefore these documents are aesthetically different than the original and contain elements of web rather than print formatting (for example, hyperlinks.) Readers with accessibility issues should [contact the department](https://www.ucl.ac.uk/computer-science/people/computer-science-key-contacts) for support with these documents. Archive documents    CS Student Handbook 2022-23 CS Student Handbook 2021-22    CS Student Handbook 2020-21